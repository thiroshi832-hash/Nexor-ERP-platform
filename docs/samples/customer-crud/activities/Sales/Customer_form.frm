...
<Form version="1" id="" dataSource="Customer">
    <Geometry x="100" y="100" width="480" height="320"/>
    <Title>Customer Detail</Title>
    <Widgets>
        <Widget type="QLabel" name="lblId" x="20" y="20" width="80" height="24">
            <Property name="text">Id:</Property>
        </Widget>
        <Widget type="QLineEdit" name="txtId" x="110" y="20" width="100" height="24" binding="Id">
            <Property name="text"></Property>
        </Widget>
        <Widget type="QLabel" name="lblName" x="20" y="60" width="80" height="24">
            <Property name="text">Name:</Property>
        </Widget>
        <Widget type="QLineEdit" name="txtName" x="110" y="60" width="340" height="24" binding="Name">
            <Property name="text"></Property>
        </Widget>
        <Widget type="QLabel" name="lblEmail" x="20" y="100" width="80" height="24">
            <Property name="text">Email:</Property>
        </Widget>
        <Widget type="QLineEdit" name="txtEmail" x="110" y="100" width="340" height="24" binding="Email">
            <Property name="text"></Property>
        </Widget>
        <Widget type="QLabel" name="lblBalance" x="20" y="140" width="80" height="24">
            <Property name="text">Balance:</Property>
        </Widget>
        <Widget type="QDoubleSpinBox" name="spnBalance" x="110" y="140" width="160" height="24" binding="Balance"/>
        <Widget type="QCheckBox" name="chkActive" x="110" y="180" width="120" height="24" binding="Active">
