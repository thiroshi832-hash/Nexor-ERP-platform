...
NewSheetDialog::NewSheetDialog(QWidget *parent) : QDialog(parent) {
    setWindowTitle("New Sheet");
    setModal(true);
    resize(500, 400);

    auto *form = new QFormLayout;
    m_titleEdit  = new QLineEdit;  m_titleEdit->setPlaceholderText("Customer");
    m_idEdit     = new QLineEdit;  m_idEdit->setPlaceholderText("Customer");
