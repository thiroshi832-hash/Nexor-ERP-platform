...
NewProjectDialog::NewProjectDialog(QWidget *parent) : QDialog(parent) {
    ...
    m_titleEdit  = new QLineEdit;   m_titleEdit->setPlaceholderText("My First Project");
    m_idEdit     = new QLineEdit;   m_idEdit->setPlaceholderText("MyFirstProject");
    ...
    connect(m_dirEdit,   &QLineEdit::textChanged, this, reval);

    // Auto-suggest ID from title (only until user types into ID).
...
void NewProjectDialog::onBrowse() {
    QString d = QFileDialog::getExistingDirectory(this, "Choose project location", m_dirEdit->text());
...
ProjectMeta NewProjectDialog::meta() const {
    ProjectMeta m;
...
QString NewProjectDialog::parentDirectory() const {
