...
NewProcessDialog::NewProcessDialog(QWidget *parent) : QDialog(parent) {
    setWindowTitle("New Process");
    setModal(true);
    resize(500, 400);

    auto *form = new QFormLayout;
    m_titleEdit  = new QLineEdit;  m_titleEdit->setPlaceholderText("OrderApproval");
    m_idEdit     = new QLineEdit;  m_idEdit->setPlaceholderText("OrderApproval");
